...
import rover.DebugRoverDisplay;
import rover.IRoverService;
import rover.MonitorInfo;
import rover.MonitorInfo.Resource;
import rover.MonitorInfo.Rover;
import rover.MonitorInfo.Team;


public class DebugMonitorAgent extends Agent  {
	...
	private DebugRoverDisplay display;

	public DebugMonitorAgent() {
		service = null;
		sb = null;
		display = null;
	...
	public void run() {
		...
		display = new DebugRoverDisplay(sb);
